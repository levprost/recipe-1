...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureDashboard(): Dashboard
    {
        return Dashboard::new()
            ->setTitle('Recipe - Administration');
    }
    ...
    public function configureMenuItems(): iterable
    {
        ...
        if($this->isGranted('ROLE_MODO')){
            yield MenuItem::section('Step1');
            yield MenuItem::submenu('Step1','fa fa-comment-dots')->setSubItems([
                MenuItem::linkToCrud('Create Comment','fas fa-newspaper', Step1::class)->setAction(Crud::PAGE_NEW),
                MenuItem::linkToCrud('Show Comment','fas fa-eye', Step1::class),
            ]);
        }
